...
PO4_data <- filtered_data %>%
  ...
  dplyr::arrange(Date) %>%
  dplyr::mutate(Date_Bin = as.Date(paste(substr(Date, 1, 2), "18", substr(Date, 5, 10), sep=""))) %>%
...
NO2_Mean_data <- filtered_data %>%
  ...
  dplyr::arrange(Date) %>%
  dplyr::mutate(Date_Bin = as.Date(paste(substr(Date, 1, 2), "18", substr(Date, 5, 10), sep=""))) %>%
  dplyr::mutate(Y_Bin = (as.numeric(as.character(Mean_NO2)))/1000)
...
N2O_Mean_data <- filtered_data %>%
  ...
  dplyr::arrange(Date) %>%
  dplyr::mutate(Date_Bin = as.Date(paste(substr(Date, 1, 2), "18", substr(Date, 5, 10), sep=""))) %>%
  dplyr::mutate(Y_Bin = as.numeric(as.character(Mean_N2O)))
...
CH4_Mean_data %>%
  ...
  geom_point() + 
  labs(title = "Fluctuations in CH4 Levels at 100m By Day of Year", x = "Date of Sample", y = "[CH4] in μM") +
...
CO2_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in CO2 Levels at 100m By Day of Year", x = "Date of Sample", y = "[CO2] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
H2S_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in H2S Levels at 100m By Day of Year", x = "Date of Sample", y = "[H2S] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
N2_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in N2 Levels at 100m By Day of Year", x = "Date of Sample", y = "[N2] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
N2O_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in N2O Levels at 100m By Day of Year", x = "Date of Sample", y = "[N2O] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
NH4_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in NH4 Levels at 100m By Day of Year", x = "Date of Sample", y = "[NH4] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
NO2_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in NO2 Levels at 100m By Day of Year", x = "Date of Sample", y = "[NO2] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
NO3_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in NO3 Levels at 100m By Day of Year", x = "Date of Sample", y = "[NO3] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
O2_Mean_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in O2 Levels at 100m By Day of Year", x = "Date of Sample", y = "[O2] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
PO4_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in PO4 Levels at 100m By Day of Year", x = "Date of Sample", y = "[PO4] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
SI_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in SI Levels at 100m By Day of Year", x = "Date of Sample", y = "[SI] in μM") +
  geom_smooth(method = loess) +
  theme_classic()
...
Cell_Density_data %>%
  ggplot(aes(x=Date_Bin, y=Y_Bin)) + 
  geom_point() + 
  labs(title = "Fluctuations in Cell Density Levels at 100m By Day of Year", x = "Date of Sample", y = "Cell Density in Cells/mL") +
  geom_smooth(method = loess) +
  theme_classic()
